...
<\body>
  ...
  are sets. It is used for filtering the objects and morphisms in
  ...
  <\definition>
    [Diagram] Given a small category <math|<math-ss|I>> and a category
  ...
  <\definition>
    [Cone] Given a small category <math|<math-ss|I>> and a category
  ...
  <math|<math-ss|I>> and <math|<math-ss|C>> small categories. Given a summit
  object <math|X\<in\><math-ss|C>> and a diagram
  ...
  <\definition>
    [Cone Functor] Let <math|<math-ss|I>> and <math|<math-ss|C>> small
    categories. For each diagram <math|D:<math-ss|I>\<rightarrow\><math-ss|C>>,
    the cone functor <math|Cone<around*|(|-,D|)>:<math-ss|C><rsup|op>\<rightarrow\><math-ss|Set>>
    is defined by
  ...
  Universality>, for a small category <math|<math-ss|C>>, a functor
  ...
  <\definition>
    [Universal Cone] Let <math|<math-ss|I>> and <math|<math-ss|C>> small
    categories. For a diagram <math|D:<math-ss|I>\<rightarrow\><math-ss|C>>,
    a <with|font-series|bold|universal cone> is a pair
  ...
  In this section, we show that many mathematical concepts are in fact limits
  or colimits. We restrict the discussion to what have been discussed before:
  infimum and supremum, Cartesian product and adjoint union. Lots of very
  interesting instances can be found in the <hlink|wonderful
  blog|https://www.math3ma.com/blog/limits-and-colimits-part-3> posted by
  Tai-Danae Bradley. This blog is really an adventure of mathematics. And you
  should read it over after reading this section.

  <subsubsection|Infimum (supremum) is the limit (colimit) on poset
  <math|\<bbb-R\>>>
  ...
  <subsubsection|Product (coproduct) is a limit (colimit)>

  Recall the definition of product (definition <reference|definition: Product
  of Two Objects>): Given a category <math|<math-ss|C>>. For any
  <math|A,B\<in\><math-ss|C>>, the product of <math|A> and <math|B> is
  another object <math|C\<in\><math-ss|C>> together with two morphisms
  <math|\<alpha\>:C\<rightarrow\>A> and <math|\<beta\>:C\<rightarrow\>B> such
  that, for any <math|C<rprime|'>\<in\><math-ss|C>>, any
  ...
  <math|\<beta\><rprime|'>=\<beta\>\<circ\>\<gamma\>>. As figure
  <reference|figure: Product is Limit> indicates, product is a limit, in
  which the discrete category with two elements is the indexing category.
...
<\references>
  <\collection>
    ...
    <associate|auto-30|<tuple|4.5.1|8>>
    <associate|auto-31|<tuple|4.5.2|8>>
    <associate|auto-32|<tuple|9|8>>
